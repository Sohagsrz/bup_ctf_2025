...
public class SearchBar extends Toolbar {
    ...
    /* synthetic */ void m123lambda$new$0$comgoogleandroidmaterialsearchSearchBar(boolean enabled) {
    ...
    public SearchBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.touchExplorationStateChangeListener = new AccessibilityManagerCompat.TouchExplorationStateChangeListener() { // from class: com.google.android.material.search.SearchBar$$ExternalSyntheticLambda1
            ...
            public final void onTouchExplorationStateChanged(boolean z) {
                this.f$0.m123lambda$new$0$comgoogleandroidmaterialsearchSearchBar(z);
            }
        };
    ...
    public static class ScrollingViewBehavior extends AppBarLayout.ScrollingViewBehavior {
        ...
        public boolean onDependentViewChanged(CoordinatorLayout parent, View child, View dependency) throws Resources.NotFoundException {
