...
public class BufferedChannel<E> implements Channel<E> {
    ...
    public Object mo1672receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        return m1670receiveCatchingJP2dKIU$suspendImpl(this, continuation);
    }
    ...
    public final Object onClosedSend(E e, Continuation<? super Unit> continuation) {
        ...
        if (function1 != null && (it = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) != null) {
            ...
            $this$resumeWithStackTrace$iv.resumeWith(Result.m167constructorimpl(ResultKt.createFailure(undeliveredElementExceptionRecoverFromStackFrame)));
        } else {
            ...
            $this$resumeWithStackTrace$iv2.resumeWith(Result.m167constructorimpl(ResultKt.createFailure(thRecoverFromStackFrame)));
        }
        ...
        try {
            switch (updateCellSend(channelSegment, index, e, s, cont, false)) {
                case 0:
                    ...
                    Result.Companion companion = Result.INSTANCE;
                    cont.resumeWith(Result.m167constructorimpl(Unit.INSTANCE));
                    break;
                case 1:
                    Result.Companion companion2 = Result.INSTANCE;
                    cont.resumeWith(Result.m167constructorimpl(Unit.INSTANCE));
                    ...
                    while (true) {
                        ...
                        switch (updateCellSend(segment$iv$iv, i$iv$iv, e, s$iv$iv, cont2, closed$iv$iv)) {
                            case 0:
                                ...
                                cont2.resumeWith(Result.m167constructorimpl(Unit.INSTANCE));
                                break;
                            case 1:
    ...
    public final void onClosedSendOnNoWaiterSuspend(E element, CancellableContinuation<? super Unit> cont) {
        ...
        Result.Companion companion = Result.INSTANCE;
        cancellableContinuation.resumeWith(Result.m167constructorimpl(ResultKt.createFailure(exception$iv)));
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo1668trySendJP2dKIU(E element) {
        ChannelSegment segment$iv;
        if (shouldSendSuspend(sendersAndCloseStatus$FU.get(this))) {
            return ChannelResult.INSTANCE.m1692failurePtdJZtk();
        }
        ...
        while (true) {
            ...
            if (segment$iv2.id != id$iv) {
                ...
                if (segment$iv == null) {
                    if (closed$iv) {
                        return ChannelResult.INSTANCE.m1691closedJP2dKIU(getSendException());
                    }
                }
            } else {
            ...
            switch (updateCellSend(segment$iv, i$iv, element, s$iv, waiter$iv, closed$iv)) {
                case 0:
                    segment$iv.cleanPrev();
                    return ChannelResult.INSTANCE.m1693successJP2dKIU(Unit.INSTANCE);
                case 1:
                    return ChannelResult.INSTANCE.m1693successJP2dKIU(Unit.INSTANCE);
                case 2:
                    if (closed$iv) {
        ...
        while (true) {
            ...
            if (segment$iv.id != id$iv) {
                ...
                if (channelSegmentFindSegmentSend != null) {
                    ...
                    Result.Companion companion = Result.INSTANCE;
                    cont.resumeWith(Result.m167constructorimpl(Boxing.boxBoolean(false)));
                } else {
                    z = z2;
                }
            }
            switch (bufferedChannel.updateCellSend(segment$iv, i$iv, e, s$iv, waiter$iv, closed$iv)) {
                case 0:
                    segment$iv.cleanPrev();
                    Result.Companion companion2 = Result.INSTANCE;
                    cont.resumeWith(Result.m167constructorimpl(Boxing.boxBoolean(z2)));
                    break;
                case 1:
                    Result.Companion companion3 = Result.INSTANCE;
                    cont.resumeWith(Result.m167constructorimpl(Boxing.boxBoolean(z2)));
    ...
    private final boolean tryResumeReceiver(Object $this$tryResumeReceiver, E e) {
        ...
        if ($this$tryResumeReceiver instanceof ReceiveCatching) {
            ...
            ChannelResult channelResultM1678boximpl = ChannelResult.m1678boximpl(ChannelResult.INSTANCE.m1693successJP2dKIU(e));
            Function1<E, Unit> function1 = this.onUndeliveredElement;
            return BufferedChannelKt.tryResume0(cancellableContinuationImpl, channelResultM1678boximpl, function1 != null ? OnUndeliveredElementKt.bindCancellationFun(function1, e, ((ReceiveCatching) $this$tryResumeReceiver).cont.getContext()) : null);
        }
    ...
    public final void onClosedReceiveOnNoWaiterSuspend(CancellableContinuation<? super E> cont) {
        Result.Companion companion = Result.INSTANCE;
        cont.resumeWith(Result.m167constructorimpl(ResultKt.createFailure(getReceiveException())));
    }
    ...
    */
    static /* synthetic */ <E> java.lang.Object m1670receiveCatchingJP2dKIU$suspendImpl(kotlinx.coroutines.channels.BufferedChannel<E> r13, kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r14) throws java.lang.Throwable {
        /*
            Method dump skipped, instructions count: 226
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.BufferedChannel.m1670receiveCatchingJP2dKIU$suspendImpl(kotlinx.coroutines.channels.BufferedChannel, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.lang.Object m1671receiveCatchingOnNoWaiterSuspendGKJJFZk(kotlinx.coroutines.channels.ChannelSegment<E> r25, int r26, long r27, kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r29) throws java.lang.Throwable {
        /*
            Method dump skipped, instructions count: 454
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.BufferedChannel.m1671receiveCatchingOnNoWaiterSuspendGKJJFZk(kotlinx.coroutines.channels.ChannelSegment, int, long, kotlin.coroutines.Continuation):java.lang.Object");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void onClosedReceiveCatchingOnNoWaiterSuspend(CancellableContinuation<? super ChannelResult<? extends E>> cont) {
        Result.Companion companion = Result.INSTANCE;
        cont.resumeWith(Result.m167constructorimpl(ChannelResult.m1678boximpl(ChannelResult.INSTANCE.m1691closedJP2dKIU(getCloseCause()))));
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // kotlinx.coroutines.channels.ReceiveChannel
    /* renamed from: tryReceive-PtdJZtk, reason: not valid java name */
    public Object mo1673tryReceivePtdJZtk() {
        ...
        if (isClosedForReceive0(sendersAndCloseStatusCur)) {
            return ChannelResult.INSTANCE.m1691closedJP2dKIU(getCloseCause());
        }
        ...
        while (!isClosedForReceive()) {
            ...
            if (updCellResult$iv != BufferedChannelKt.FAILED) {
                ...
                return ChannelResult.INSTANCE.m1693successJP2dKIU(updCellResult$iv);
            }
    ...
    public final Object processResultSelectReceiveCatching(Object ignoredParam, Object selectResult) {
        return ChannelResult.m1678boximpl(selectResult == BufferedChannelKt.getCHANNEL_CLOSED() ? ChannelResult.INSTANCE.m1691closedJP2dKIU(getCloseCause()) : ChannelResult.INSTANCE.m1693successJP2dKIU(selectResult));
    }
    ...
    private final class BufferedChannelIterator implements ChannelIterator<E>, Waiter {
        ...
        public final void onClosedHasNextNoWaiterSuspend() {
            ...
            if (cause == null) {
                Result.Companion companion = Result.INSTANCE;
                cont.resumeWith(Result.m167constructorimpl(false));
                return;
            }
            ...
            Result.Companion companion2 = Result.INSTANCE;
            cancellableContinuationImpl.resumeWith(Result.m167constructorimpl(ResultKt.createFailure(thRecoverFromStackFrame)));
        }
    ...
    */
    ...
    private final void cancelSuspendedReceiveRequests(ChannelSegment<E> lastSegment, long sendersCounter) {
        Object suspendedReceivers = InlineList.m1715constructorimpl$default(null, 1, null);
            ...
            for (int index = BufferedChannelKt.SEGMENT_SIZE - 1; -1 < index; index--) {
                ...
                while (true) {
                    ...
                    if (state == null || state == BufferedChannelKt.IN_BUFFER) {
                        ...
                        if (segment.casState$kotlinx_coroutines_core(index, state, BufferedChannelKt.getCHANNEL_CLOSED())) {
                            suspendedReceivers = InlineList.m1720plusFjFbRPM(suspendedReceivers, ((WaiterEB) state).waiter);
                            segment.onCancelledRequest(index, true);
                            break;
                        }
                    } else {
                        ...
                        if (segment.casState$kotlinx_coroutines_core(index, state, BufferedChannelKt.getCHANNEL_CLOSED())) {
                            suspendedReceivers = InlineList.m1720plusFjFbRPM(suspendedReceivers, state);
                            segment.onCancelledRequest(index, true);
                            break;
                        }
                    }
    ...
    private final void resumeWaiterOnClosedChannel(Waiter $this$resumeWaiterOnClosedChannel, boolean receiver) {
        if (!($this$resumeWaiterOnClosedChannel instanceof SendBroadcast)) {
            if (!($this$resumeWaiterOnClosedChannel instanceof CancellableContinuation)) {
                ...
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuationImpl.resumeWith(Result.m167constructorimpl(ChannelResult.m1678boximpl(ChannelResult.INSTANCE.m1691closedJP2dKIU(getCloseCause()))));
                return;
            }
            Continuation continuation = (Continuation) $this$resumeWaiterOnClosedChannel;
            Result.Companion companion2 = Result.INSTANCE;
            continuation.resumeWith(Result.m167constructorimpl(ResultKt.createFailure(receiver ? getReceiveException() : getSendException())));
            return;
        }
    ...
    public final ChannelSegment<E> findSegmentSend(long id, ChannelSegment<E> startFrom) {
        ...
        while (true) {
            ...
            if (SegmentOrClosed.m1732isClosedimpl(s$iv)) {
                break;
            }
            Segment to$iv$iv = SegmentOrClosed.m1730getSegmentimpl(s$iv);
            while (true) {
        ...
        ChannelSegment segment = (ChannelSegment) SegmentOrClosed.m1730getSegmentimpl(s$iv);
        if (segment.id > id) {
