...
public interface SendChannel<E> {
    ...
    Object mo1668trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            Object result = sendChannel.mo1668trySendJP2dKIU(e);
            if (ChannelResult.m1688isSuccessimpl(result)) {
                return true;
            }
            Throwable thM1682exceptionOrNullimpl = ChannelResult.m1682exceptionOrNullimpl(result);
