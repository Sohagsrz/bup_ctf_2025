    ...
    */
    ...
    public static final Object delay(long timeMillis, Continuation<? super Unit> continuation) {
        ...
        if (timeMillis < Long.MAX_VALUE) {
            getDelay(cont.get$context()).mo1725scheduleResumeAfterDelay(timeMillis, cont);
        }
    ...
    public static final Object m1656delayVtjQ1oo(long duration, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m1657toDelayMillisLRDsOJo(duration), continuation);
    ...
    public static final long m1657toDelayMillisLRDsOJo(long $this$toDelayMillis_u2dLRDsOJo) {
        if (Duration.m1492compareToLRDsOJo($this$toDelayMillis_u2dLRDsOJo, Duration.INSTANCE.m1595getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1511getInWholeMillisecondsimpl($this$toDelayMillis_u2dLRDsOJo), 1L);
        }
        return 0L;
    }
}
