    ...
    protected final S allocateSlot() {
        ...
        synchronized (this) {
            ...
            if (abstractSharedFlowSlotArr == null) {
                ...
                Object[] objArrCopyOf = Arrays.copyOf(abstractSharedFlowSlotArr, abstractSharedFlowSlotArr.length * 2);
            ...
            do {
                AbstractSharedFlowSlot abstractSharedFlowSlotCreateSlot = abstractSharedFlowSlotArr[i];
                if (abstractSharedFlowSlotCreateSlot == null) {
                    abstractSharedFlowSlotCreateSlot = createSlot();
                    abstractSharedFlowSlotArr[i] = abstractSharedFlowSlotCreateSlot;
                }
