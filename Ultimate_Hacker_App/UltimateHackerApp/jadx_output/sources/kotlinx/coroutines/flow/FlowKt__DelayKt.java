...
final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> m1701debounceHG0u8IE(Flow<? extends T> flow, long timeout) {
        return FlowKt.debounce(flow, DelayKt.m1657toDelayMillisLRDsOJo(timeout));
    }
    ...
    public static final <T> Flow<T> debounceDuration(Flow<? extends T> flow, final Function1<? super T, Duration> function1) {
        return debounceInternal$FlowKt__DelayKt(flow, new Function1<T, Long>() { // from class: kotlinx.coroutines.flow.FlowKt__DelayKt.debounce.3
            ...
            @Override // kotlin.jvm.functions.Function1
            public final Long invoke(T t) {
                return Long.valueOf(DelayKt.m1657toDelayMillisLRDsOJo(function1.invoke(t).getRawValue()));
            }
        });
    }
        ...
        public final Object invokeSuspend(Object $result) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ...
                    c01132 = this;
                    CoroutineScope $this$scopedFlow = (CoroutineScope) c01132.L$0;
                    FlowCollector downstream2 = (FlowCollector) c01132.L$1;
                    ReceiveChannel values2 = ProduceKt.produce$default($this$scopedFlow, null, -1, new FlowKt__DelayKt$sample$2$values$1(c01132.$this_sample, null), 1, null);
                    Ref.ObjectRef lastValue2 = new Ref.ObjectRef();
                    ticker = FlowKt__DelayKt.fixedPeriodTicker$default($this$scopedFlow, c01132.$periodMillis, 0L, 2, null);
                ...
                case 1:
                    c01132 = this;
                    ticker = (ReceiveChannel) c01132.L$3;
                    lastValue = (Ref.ObjectRef) c01132.L$2;
                    values = (ReceiveChannel) c01132.L$1;
                    downstream = (FlowCollector) c01132.L$0;
                    ResultKt.throwOnFailure($result);
                    break;
                default:
            ...
            while (lastValue.element != NullSurrogateKt.DONE) {
                SelectImplementation $this$select_u24lambda_u241$iv = new SelectImplementation(c01132.get$context());
                ...
                c01132.L$0 = downstream;
                c01132.L$1 = values;
                c01132.L$2 = lastValue;
                c01132.L$3 = ticker;
                c01132.label = 1;
                if ($this$select_u24lambda_u241$iv.doSelect(c01132) == coroutine_suspended) {
    ...
    public static final <T> Flow<T> sample(Flow<? extends T> flow, long periodMillis) {
        if (periodMillis > 0) {
            return FlowCoroutineKt.scopedFlow(new C01132(periodMillis, flow, null));
        }
    ...
    public static final ReceiveChannel<Unit> fixedPeriodTicker(CoroutineScope $this$fixedPeriodTicker, long delayMillis, long initialDelayMillis) {
        ...
        return ProduceKt.produce$default($this$fixedPeriodTicker, null, 0, new C01123(initialDelayMillis, delayMillis, null), 1, null);
    }
    ...
    public static final <T> Flow<T> m1702sampleHG0u8IE(Flow<? extends T> flow, long period) {
        return FlowKt.sample(flow, DelayKt.m1657toDelayMillisLRDsOJo(period));
    }

    /* renamed from: timeout-HG0u8IE, reason: not valid java name */
    public static final <T> Flow<T> m1703timeoutHG0u8IE(Flow<? extends T> flow, long timeout) {
        return m1704timeoutInternalHG0u8IE$FlowKt__DelayKt(flow, timeout);
    }

    /* renamed from: timeoutInternal-HG0u8IE$FlowKt__DelayKt, reason: not valid java name */
    private static final <T> Flow<T> m1704timeoutInternalHG0u8IE$FlowKt__DelayKt(Flow<? extends T> flow, long timeout) {
