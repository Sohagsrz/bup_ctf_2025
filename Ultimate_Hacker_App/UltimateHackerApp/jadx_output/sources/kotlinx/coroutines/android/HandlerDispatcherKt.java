...
public final class HandlerDispatcherKt {
    ...
    public static final Handler asHandler(Looper $this$asHandler, boolean async) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        if (!async) {
    ...
    static {
        ...
        try {
            ...
            objM167constructorimpl = Result.m167constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM167constructorimpl = Result.m167constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m173isFailureimpl(objM167constructorimpl) ? null : objM167constructorimpl);
    }
    ...
    public static final Object awaitFrameSlowPath(Continuation<? super Long> continuation) {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            Dispatchers.getMain().mo1724dispatch(cont.getContext(), new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrameSlowPath$lambda$3$$inlined$Runnable$1
