...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM167constructorimpl2;
        ...
        try {
            ...
            objM167constructorimpl = Result.m167constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM167constructorimpl = Result.m167constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m170exceptionOrNullimpl(objM167constructorimpl) == null) {
            obj2 = objM167constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM167constructorimpl2 = Result.m167constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM167constructorimpl2 = Result.m167constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m170exceptionOrNullimpl(objM167constructorimpl2) == null) {
            obj = objM167constructorimpl2;
        }
