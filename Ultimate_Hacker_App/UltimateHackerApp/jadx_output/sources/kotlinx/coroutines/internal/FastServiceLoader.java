...
public final class FastServiceLoader {
    ...
    public final List<MainDispatcherFactory> loadMainDispatcherFactory$kotlinx_coroutines_core() {
        ...
        try {
            ...
            try {
                ...
                $this$loadMainDispatcherFactory_u24lambda_u240 = (MainDispatcherFactory) MainDispatcherFactory.class.cast(clz$iv.getDeclaredConstructor(new Class[0]).newInstance(new Object[0]));
            ...
            try {
                ...
                $this$loadMainDispatcherFactory_u24lambda_u241 = (MainDispatcherFactory) MainDispatcherFactory.class.cast(clz$iv2.getDeclaredConstructor(new Class[0]).newInstance(new Object[0]));
    ...
    private final MainDispatcherFactory createInstanceOf(Class<MainDispatcherFactory> baseClass, String serviceClass) throws ClassNotFoundException {
        try {
