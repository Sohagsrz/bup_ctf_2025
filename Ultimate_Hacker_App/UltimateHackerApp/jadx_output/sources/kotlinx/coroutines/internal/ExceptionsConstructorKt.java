...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        Object objM167constructorimpl;
        if (e instanceof CopyableThrowable) {
            try {
                Result.Companion companion = Result.INSTANCE;
                objM167constructorimpl = Result.m167constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM167constructorimpl = Result.m167constructorimpl(ResultKt.createFailure(th));
            }
            if (Result.m173isFailureimpl(objM167constructorimpl)) {
                objM167constructorimpl = null;
            }
            return (E) objM167constructorimpl;
        }
            ...
            switch (p.length) {
                case 0:
                    ...
                    pair = TuplesKt.to(safeCtor(new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createConstructor$1$4
                        ...
                        @Override // kotlin.jvm.functions.Function1
                        public final Throwable invoke(Throwable e) throws IllegalAccessException, InstantiationException, IllegalArgumentException, InvocationTargetException {
        ...
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt.safeCtor.1
            ...
            public final Throwable invoke(Throwable e) {
                ...
                try {
                    ...
                    objM167constructorimpl = Result.m167constructorimpl((Intrinsics.areEqual(e.getMessage(), result.getMessage()) || Intrinsics.areEqual(result.getMessage(), e.toString())) ? result : null);
                } catch (Throwable th) {
                    Result.Companion companion2 = Result.INSTANCE;
                    objM167constructorimpl = Result.m167constructorimpl(ResultKt.createFailure(th));
                }
                return (Throwable) (Result.m173isFailureimpl(objM167constructorimpl) ? null : objM167constructorimpl);
            }
        };
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int defaultValue) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM167constructorimpl = Result.m167constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM167constructorimpl = Result.m167constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m173isFailureimpl(objM167constructorimpl)) {
            objM167constructorimpl = numValueOf;
        }
        return ((Number) objM167constructorimpl).intValue();
    }
