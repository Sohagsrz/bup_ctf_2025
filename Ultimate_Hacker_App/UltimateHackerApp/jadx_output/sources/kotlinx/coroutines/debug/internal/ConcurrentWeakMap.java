...
public final class ConcurrentWeakMap<K, V> extends AbstractMutableMap<K, V> {
    ...
    private final class Core {
        ...
        public final Object putImpl(K key, V value, HashedWeakRef<K> weakKey0) {
            ...
            while (true) {
                ...
                if (w != null) {
                    ...
                    if (!loadIncremented) {
                        ...
                        do {
                            n = atomicfu$handler$iv.get(this);
                            if (n >= this.threshold) {
                                return ConcurrentWeakMapKt.REHASH;
                            }
                        } while (!atomicfu$handler$iv.compareAndSet(this, n, n + 1));
                        loadIncremented = true;
                    }
                    if (weakKey == null) {
                        weakKey = new HashedWeakRef(key, ((ConcurrentWeakMap) ConcurrentWeakMap.this).weakRefQueue);
                    }
                    if (ChannelSegment$$ExternalSyntheticBackportWithForwarding0.m(this.keys, index, null, weakKey)) {
                        break;
                    }
                }
            }
            ...
            } while (!ChannelSegment$$ExternalSyntheticBackportWithForwarding0.m(this.values, index, oldValue, value));
            return oldValue;
        }
                ...
                for (int i2 = 0; i2 < i; i2++) {
                    ...
                    while (true) {
                        ...
                        if (!(obj instanceof Marked)) {
                            if (ChannelSegment$$ExternalSyntheticBackportWithForwarding0.m(this.values, i2, obj, ConcurrentWeakMapKt.mark(obj))) {
                                break;
                            }
                        } else {
                            obj = ((Marked) obj).ref;
