        ...
        while (isLocked()) {
            ...
            if (curOwner != MutexKt.NO_OWNER) {
                if (curOwner == owner || owner == null) {
                    if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(owner$FU, this, curOwner, MutexKt.NO_OWNER)) {
                        release();
                        return;
                    }
                } else {
    ...
    private final class CancellableContinuationWithOwner implements CancellableContinuation<Unit>, Waiter {
        ...
        public Object tryResume2(Unit value, Object idempotent, Function1<? super Throwable, Unit> onCancellation) {
            ...
            if (token != null) {
                ...
                if (DebugKt.getASSERTIONS_ENABLED()) {
                    if (!(MutexImpl.owner$FU.get(mutexImpl3) == MutexKt.NO_OWNER)) {
                        throw new AssertionError();
                    }
                }
