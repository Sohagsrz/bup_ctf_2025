...
public final class ExecutorCoroutineDispatcherImpl extends ExecutorCoroutineDispatcher implements Delay {
    ...
    public void mo1724dispatch(CoroutineContext context, Runnable block) {
        ...
        try {
            ...
            Dispatchers.getIO().mo1724dispatch(context, block);
        }
    }

    @Override // kotlinx.coroutines.Delay
    /* renamed from: scheduleResumeAfterDelay */
    public void mo1725scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        long timeMillis2;
        Executor executor = getExecutor();
        ...
        if (scheduledExecutorService != null) {
            ...
            future = scheduleBlock(scheduledExecutorService, new ResumeUndispatchedRunnable(this, continuation), continuation.get$context(), timeMillis2);
        } else {
            timeMillis2 = timeMillis;
        }
        if (future != null) {
            ...
            DefaultExecutor.INSTANCE.mo1725scheduleResumeAfterDelay(timeMillis2, continuation);
        }
    }
    ...
    public DisposableHandle invokeOnTimeout(long timeMillis, Runnable block, CoroutineContext context) {
        ...
        return future != null ? new DisposableFutureHandle(future) : DefaultExecutor.INSTANCE.invokeOnTimeout(timeMillis2, block2, context2);
    }
