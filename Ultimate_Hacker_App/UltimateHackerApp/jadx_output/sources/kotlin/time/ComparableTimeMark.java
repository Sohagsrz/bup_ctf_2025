...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    ComparableTimeMark mo1483minusLRDsOJo(long duration);

    /* renamed from: minus-UwyO8pc */
    long mo1484minusUwyO8pc(ComparableTimeMark other);

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    ComparableTimeMark mo1485plusLRDsOJo(long duration);
    ...
    public static final class DefaultImpls {
        ...
        public static ComparableTimeMark m1488minusLRDsOJo(ComparableTimeMark $this, long duration) {
            return $this.mo1485plusLRDsOJo(Duration.m1545unaryMinusUwyO8pc(duration));
        }

        public static int compareTo(ComparableTimeMark $this, ComparableTimeMark other) {
            Intrinsics.checkNotNullParameter(other, "other");
            return Duration.m1492compareToLRDsOJo($this.mo1484minusUwyO8pc(other), Duration.INSTANCE.m1595getZEROUwyO8pc());
        }
    }
}
