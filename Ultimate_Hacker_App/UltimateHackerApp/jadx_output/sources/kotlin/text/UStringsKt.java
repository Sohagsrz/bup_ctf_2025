...
public final class UStringsKt {
    ...
    public static final String m1479toStringLxnNnR4(byte $this$toString_u2dLxnNnR4, int radix) {
    ...
    public static final String m1481toStringolVBNx4(short $this$toString_u2dolVBNx4, int radix) {
    ...
    public static final String m1480toStringV7xB4Y4(int $this$toString_u2dV7xB4Y4, int radix) {
        String string = Long.toString($this$toString_u2dV7xB4Y4 & 4294967295L, CharsKt.checkRadix(radix));
        Intrinsics.checkNotNullExpressionValue(string, "toString(this, checkRadix(radix))");
        return string;
    }

    /* renamed from: toString-JSWoG40, reason: not valid java name */
    public static final String m1478toStringJSWoG40(long $this$toString_u2dJSWoG40, int radix) {
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m262constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m262constructorimpl(SupportMenu.USER_MASK) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m262constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            int result2 = UInt.m262constructorimpl(result * uradix);
            result = UInt.m262constructorimpl(UInt.m262constructorimpl(digit) + result2);
            if (Integer.compare(result ^ Integer.MIN_VALUE, result2 ^ Integer.MIN_VALUE) < 0) {
                return null;
            }
        }
        return UInt.m256boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m341constructorimpl(i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            long result2 = ULong.m341constructorimpl(result * uradix);
            result = ULong.m341constructorimpl(ULong.m341constructorimpl(UInt.m262constructorimpl(digit) & 4294967295L) + result2);
        ...
        return ULong.m335boximpl(result);
    }
}
