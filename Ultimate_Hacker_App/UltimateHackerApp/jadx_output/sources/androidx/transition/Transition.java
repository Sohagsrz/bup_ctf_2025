    ...
    void createAnimators(ViewGroup sceneRoot, TransitionValuesMaps startValues, TransitionValuesMaps endValues, ArrayList<TransitionValues> startValuesList, ArrayList<TransitionValues> endValuesList) {
                ...
                if (isChanged) {
                    ...
                    if (animator != null) {
                        ...
                        if (end != null) {
                            ...
                            if (properties != null && properties.length > 0) {
                                ...
                                while (true) {
                                    ...
                                    Animator anim = runningAnimators.keyAt(j4);
                        ...
                        if (animator != null) {
                            ...
                            AnimationInfo info2 = new AnimationInfo(view, getName(), this, sceneRoot.getWindowId(), infoValues, animator);
        ...
        if (startDelays.size() != 0) {
            for (int i2 = 0; i2 < startDelays.size(); i2++) {
                ...
                long delay3 = (startDelays.valueAt(i2) - minStartDelay) + info3.mAnimator.getStartDelay();
                info3.mAnimator.setStartDelay(delay3);
            }
        }
    }
        ...
        private void ensureAnimation() {
            ...
            this.mSpringAnimation.addEndListener(new DynamicAnimation.OnAnimationEndListener() { // from class: androidx.transition.Transition$SeekController$$ExternalSyntheticLambda0
                ...
                public final void onAnimationEnd(DynamicAnimation dynamicAnimation, boolean z, float f, float f2) {
                    this.f$0.m67x76b2d240(dynamicAnimation, z, f, f2);
                }
            });
        }

        /* renamed from: lambda$ensureAnimation$0$androidx-transition-Transition$SeekController, reason: not valid java name */
        /* synthetic */ void m67x76b2d240(DynamicAnimation anim, boolean canceled, float value, float velocity) {
            if (!canceled) {
