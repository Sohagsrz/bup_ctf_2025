...
public class TransitionInflater {
    ...
    public Transition inflateTransition(int resource) throws Resources.NotFoundException {
    ...
    public TransitionManager inflateTransitionManager(int resource, ViewGroup sceneRoot) throws Resources.NotFoundException {
        XmlResourceParser parser = this.mContext.getResources().getXml(resource);
        try {
            try {
    ...
    */
    private androidx.transition.Transition createTransitionFromXml(org.xmlpull.v1.XmlPullParser r9, android.util.AttributeSet r10, androidx.transition.Transition r11) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException, java.lang.ClassNotFoundException {
        /*
    ...
    private void getTargetIds(XmlPullParser parser, AttributeSet attrs, Transition transition) throws XmlPullParserException, IOException, ClassNotFoundException {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private androidx.transition.TransitionManager createTransitionManagerFromXml(org.xmlpull.v1.XmlPullParser r8, android.util.AttributeSet r9, android.view.ViewGroup r10) throws org.xmlpull.v1.XmlPullParserException, android.content.res.Resources.NotFoundException, java.io.IOException {
        /*
            r7 = this;
            int r0 = r8.getDepth()
            r1 = 0
