...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        while (true) {
            ...
            if (!staggeredGridLayoutManager3.mLayoutState.mInfinite && staggeredGridLayoutManager3.mRemainingSpans.isEmpty()) {
                i2 = r8;
                break;
            }
            ...
            boolean z2 = span2 == -1 ? r9 : r8;
            if (z2) {
                nextSpan = layoutParams.mFullSpan ? staggeredGridLayoutManager3.mSpans[r8] : staggeredGridLayoutManager3.getNextSpan(layoutState);
                staggeredGridLayoutManager3.mLazySpanLookup.setSpan(viewLayoutPosition, nextSpan);
            } else {
                nextSpan = staggeredGridLayoutManager3.mSpans[span2];
            }
            ...
            if (layoutState.mLayoutDirection == r9) {
                decoratedMeasurement = layoutParams.mFullSpan ? staggeredGridLayoutManager3.getMaxEnd(i5) : nextSpan.getEndLine(i5);
                ...
                minStart = layoutParams.mFullSpan ? staggeredGridLayoutManager3.getMinStart(i5) : nextSpan.getStartLine(i5);
            ...
            if (layoutParams.mFullSpan && layoutState.mItemDirection == -1) {
                if (z2) {
                    staggeredGridLayoutManager3.mLaidOutInvalidFullSpan = r9;
                } else {
                    if ((layoutState.mLayoutDirection == r9 ? (staggeredGridLayoutManager3.areAllEndsEqual() ? 1 : 0) ^ r9 : (staggeredGridLayoutManager3.areAllStartsEqual() ? 1 : 0) ^ r9) != 0) {
            ...
            if (staggeredGridLayoutManager3.isLayoutRTL() && staggeredGridLayoutManager3.mOrientation == r9) {
                decoratedMeasurement2 = layoutParams.mFullSpan ? staggeredGridLayoutManager3.mSecondaryOrientation.getEndAfterPadding() : staggeredGridLayoutManager3.mSecondaryOrientation.getEndAfterPadding() - (((staggeredGridLayoutManager3.mSpanCount - r9) - nextSpan.mIndex) * staggeredGridLayoutManager3.mSizePerSpan);
                startAfterPadding2 = decoratedMeasurement2 - staggeredGridLayoutManager3.mSecondaryOrientation.getDecoratedMeasurement(next);
            } else {
                startAfterPadding2 = layoutParams.mFullSpan ? staggeredGridLayoutManager3.mSecondaryOrientation.getStartAfterPadding() : (nextSpan.mIndex * staggeredGridLayoutManager3.mSizePerSpan) + staggeredGridLayoutManager3.mSecondaryOrientation.getStartAfterPadding();
            ...
            if (staggeredGridLayoutManager3.mOrientation == 1) {
                span = nextSpan;
                i3 = i8;
                staggeredGridLayoutManager3.layoutDecoratedWithMargins(next, i3, i6, decoratedMeasurement2, i7);
                staggeredGridLayoutManager = this;
            } else {
                span = nextSpan;
                StaggeredGridLayoutManager staggeredGridLayoutManager4 = this;
                staggeredGridLayoutManager4.layoutDecoratedWithMargins(next, i6, i8, i7, decoratedMeasurement2);
                i3 = i8;
            ...
            if (layoutParams.mFullSpan) {
                ...
                staggeredGridLayoutManager.updateRemainingSpans(span, staggeredGridLayoutManager.mLayoutState.mLayoutDirection, i);
            }
            ...
            if (!staggeredGridLayoutManager.mLayoutState.mStopInFocusable || !next.hasFocusable()) {
                ...
                i4 = 0;
                staggeredGridLayoutManager.mRemainingSpans.set(span.mIndex, false);
            }
            z = true;
            r8 = i4;
            r9 = 1;
