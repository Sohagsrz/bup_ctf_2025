...
public class ProfileInstaller {
    ...
    public static void writeProfile(Context context, Executor executor, DiagnosticsCallback diagnostics) throws PackageManager.NameNotFoundException, IOException {
        writeProfile(context, executor, diagnostics, false);
    }

    static void writeProfile(Context context, Executor executor, DiagnosticsCallback diagnostics, boolean forceWriteProfile) throws PackageManager.NameNotFoundException, IOException {
    ...
    static void writeSkipFile(Context context, Executor executor, DiagnosticsCallback diagnostics) throws PackageManager.NameNotFoundException {
        Context appContext = context.getApplicationContext();
        String packageName = appContext.getPackageName();
        PackageManager packageManager = context.getPackageManager();
        try {
