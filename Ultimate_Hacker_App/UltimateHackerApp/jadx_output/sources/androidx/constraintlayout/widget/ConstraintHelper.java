...
public abstract class ConstraintHelper extends View {
    ...
    public ConstraintHelper(Context context) throws IllegalAccessException, NoSuchFieldException, Resources.NotFoundException, IllegalArgumentException {
        super(context);
    ...
    public ConstraintHelper(Context context, AttributeSet attrs) throws IllegalAccessException, NoSuchFieldException, Resources.NotFoundException, IllegalArgumentException {
        super(context, attrs);
        this.mIds = new int[32];
        this.mUseViewMeasure = false;
        this.mViews = null;
    ...
    public ConstraintHelper(Context context, AttributeSet attrs, int defStyleAttr) throws IllegalAccessException, NoSuchFieldException, Resources.NotFoundException, IllegalArgumentException {
    ...
    protected void init(AttributeSet attrs) throws IllegalAccessException, NoSuchFieldException, Resources.NotFoundException, IllegalArgumentException {
        if (attrs != null) {
    ...
    private void addID(String idString) throws IllegalAccessException, NoSuchFieldException, Resources.NotFoundException, IllegalArgumentException {
    ...
    private int findId(String referenceId) throws IllegalAccessException, NoSuchFieldException, Resources.NotFoundException, IllegalArgumentException {
        ConstraintLayout parent = null;
        if (getParent() instanceof ConstraintLayout) {
            parent = (ConstraintLayout) getParent();
        }
    ...
    protected void setIds(String idList) throws IllegalAccessException, NoSuchFieldException, Resources.NotFoundException, IllegalArgumentException {
    ...
    public void updatePreLayout(ConstraintLayout container) throws IllegalAccessException, NoSuchFieldException, Resources.NotFoundException, IllegalArgumentException {
        String candidate;
        int foundId;
        if (isInEditMode()) {
            setIds(this.mReferenceIds);
    ...
    private int[] convertReferenceString(String referenceIdString) throws IllegalAccessException, NoSuchFieldException, Resources.NotFoundException, IllegalArgumentException {
