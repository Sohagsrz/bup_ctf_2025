...
public class ConstraintLayout extends ViewGroup {
    ...
    public ConstraintLayout(Context context) throws XmlPullParserException, NumberFormatException, IOException {
        super(context);
    ...
    public ConstraintLayout(Context context, AttributeSet attrs) throws XmlPullParserException, NumberFormatException, IOException {
        super(context, attrs);
        this.mChildrenByIds = new SparseArray<>();
        this.mConstraintHelpers = new ArrayList<>(4);
        this.mLayoutWidget = new ConstraintWidgetContainer();
    ...
    public ConstraintLayout(Context context, AttributeSet attrs, int defStyleAttr) throws XmlPullParserException, NumberFormatException, IOException {
    ...
    public ConstraintLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) throws XmlPullParserException, NumberFormatException, IOException {
    ...
    private void init(AttributeSet attrs, int defStyleAttr, int defStyleRes) throws XmlPullParserException, NumberFormatException, IOException {
    ...
    private boolean updateHierarchy() throws IllegalAccessException, NoSuchFieldException, Resources.NotFoundException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
    ...
    private void setChildrenConstraints() throws IllegalAccessException, NoSuchFieldException, Resources.NotFoundException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) throws NumberFormatException {
            super(c, attrs);
            this.guideBegin = -1;
            this.guideEnd = -1;
            this.guidePercent = -1.0f;
    ...
    public String getSceneString() throws Resources.NotFoundException {
        int id;
