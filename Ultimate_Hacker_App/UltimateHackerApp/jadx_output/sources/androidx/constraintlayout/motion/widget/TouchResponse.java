        ...
        switch (event.getAction()) {
            ...
            case 2:
                ...
                if (Math.abs(drag) > this.mDragThreshold || this.mDragStarted) {
                    ...
                    float movmentInDir = (this.mTouchDirectionX * this.mAnchorDpDt[r22]) + (this.mTouchDirectionY * this.mAnchorDpDt[r21]);
                    if (Math.abs(movmentInDir * this.mDragScale) < 0.01d) {
                        this.mAnchorDpDt[r22] = 0.01f;
                        this.mAnchorDpDt[r21] = 0.01f;
                    }
                    if (this.mTouchDirectionX != 0.0f) {
                        change = dx / this.mAnchorDpDt[r22];
                    } else {
                        change = dy / this.mAnchorDpDt[r21];
                    }
                    ...
                    if (pos4 != current) {
                        if (current == 0.0f || current == 1.0f) {
                            this.mMotionLayout.endTrigger(current == 0.0f ? r21 : r22);
                        }
                        ...
                        if (this.mTouchDirectionX != 0.0f) {
                            velocity2 = tvx3 / this.mAnchorDpDt[r22];
                        } else {
                            velocity2 = tvy2 / this.mAnchorDpDt[r21];
                        }
