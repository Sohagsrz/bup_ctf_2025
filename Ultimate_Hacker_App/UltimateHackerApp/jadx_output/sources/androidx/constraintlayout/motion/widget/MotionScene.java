...
public class MotionScene {
    ...
    public static class Transition {
        ...
        Transition(MotionScene motionScene, Context context, XmlPullParser parser) throws XmlPullParserException, Resources.NotFoundException, NumberFormatException, IOException {
            this.mId = -1;
            this.mIsAbstract = false;
            this.mConstraintSetEnd = -1;
            this.mConstraintSetStart = -1;
        ...
        private void fillFromAttributeList(MotionScene motionScene, Context context, AttributeSet attrs) throws XmlPullParserException, Resources.NotFoundException, NumberFormatException, IOException {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.Transition);
            fill(motionScene, context, a);
            a.recycle();
        }

        private void fill(MotionScene motionScene, Context context, TypedArray a) throws XmlPullParserException, Resources.NotFoundException, NumberFormatException, IOException {
            int count = a.getIndexCount();
            for (int i = 0; i < count; i++) {
                int attr = a.getIndex(i);
    ...
    MotionScene(Context context, MotionLayout layout, int resourceID) throws XmlPullParserException, Resources.NotFoundException, NumberFormatException, IOException {
        this.mMotionLayout = layout;
        this.mViewTransitionController = new ViewTransitionController(layout);
    ...
    */
    private void load(android.content.Context r12, int r13) throws org.xmlpull.v1.XmlPullParserException, android.content.res.Resources.NotFoundException, java.lang.NumberFormatException, java.io.IOException {
        /*
    ...
    private void parseInclude(Context context, XmlPullParser mainParser) throws XmlPullParserException, Resources.NotFoundException, NumberFormatException, IOException {
    ...
    public int parseInclude(Context context, int resourceId) throws XmlPullParserException, Resources.NotFoundException, NumberFormatException, IOException {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private int parseConstraintSet(android.content.Context r19, org.xmlpull.v1.XmlPullParser r20) throws java.lang.NumberFormatException {
        /*
