...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    boolean onSuggestionsKey(View v, int keyCode, KeyEvent event) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
    ...
    private static class PreQAutoCompleteTextViewReflector {
        ...
        void ensureImeVisible(AutoCompleteTextView view) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            preApi29Check();
