#!/usr/bin/env python3
"""
Decrypt ALL hex messages with ALL hex IDs
Look at the decrypted content for clues about the correct key or flag
"""
...
print("\n" + "=" * 80)
print("DECRYPTING ALL MESSAGES - LOOKING FOR LONGEST FLAGS")
print("=" * 80)
            ...
            try:
                ...
                if flag_match:
                    ...
                    if len(flag_content) > 8:
                        ...
                        if alnum_count / len(flag_content) > 0.85:
...
if all_flags:
    ...
    print(f"\nFound {len(all_flags)} potential flags")
    print("\nTop 30 flags (by length):")
    print("-" * 80)
