#!/usr/bin/env python3
"""
Decrypt ALL hex messages with ALL hex IDs from knight messages
Look for patterns and longer flags
"""
...
print("\n" + "=" * 80)
print("DECRYPTING ALL MESSAGES WITH ALL HEX IDs")
print("=" * 80)
...
if all_results:
    ...
    print(f"Found {len(all_results)} flags longer than 12 characters:\n")
    print("-" * 80)
    ...
    print("No flags longer than 12 characters found")
