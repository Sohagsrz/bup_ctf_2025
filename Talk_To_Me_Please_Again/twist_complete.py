#!/usr/bin/env python3
"""
Complete implementation with magic number in both phases
"""
...
def twist_forward(input_data, key):
    """Forward with magic number in phase 1 too"""
    ...
    # Phase 1 - use magic number for kdata index
    r12 = key & 0xF
    r15 = key & 0xFFFF
    for i in range(length):
        val = (r12 + i) & 0xFFFFFFFFFFFFFFFF
        kdata_idx = calc_kdata_idx_magic(val)  # Use magic number!
        shift = (i * 5) & 0xf
